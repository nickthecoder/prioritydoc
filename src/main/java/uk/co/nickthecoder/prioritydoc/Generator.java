...
public class Generator
{
    ...
    /**
     * Create a Generator
     * @param root  Details of all the classes etc to document. Not null.
     */    
     ...
     * @priority 2
     * @param packageDocs Not null.
     */
    protected void generatePackages(PackageDoc[] packageDocs)
        throws Exception
    {
   ...
   /**
     ...
     * @param classDocs Not null, may be empty.
     * @priority 2
     */
    protected void generateClasses(ClassDoc[] classDocs)
        throws Exception
    {
     ...
     * @param classDoc, the sub-class which has all of its methods combined into a list. Not null.
     *
     ...
     * @param methodsByName, a map of lists of MethodDocs keyed on the method names.
     * @param item the item which may be added into the collection.
     * @priority 4
     */
